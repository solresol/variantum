...
every prompt condition. These are within-project reference-similarity
trends, not calibrated measures of philological correctness or human
equivalence.
...
the confound analysis, treatment summaries, exact-permutation code,
length diagnostics, the complete saved rating and helper-exposure
history for the three co-author reviewers, and the seeded Greek and
Chinese assignment procedures. The review logs identify the co-author reviewers
...
\input{generated/greek-xcomet-metrics.tex}
