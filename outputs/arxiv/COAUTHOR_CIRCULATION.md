...
1. the paper's argument, results, caveats, author order, affiliations, abstract,
   acknowledgements, arXiv categories, and licence;
2. the release of Shirley's ten expert reference translations and the complete
   set of 280 Chinese model outputs;
3. the release of the three co-author reviewers' rating histories, revision
   timestamps, and helper-card exposure instrumentation; and
4. whether any correction is required before Greg makes the repository and
   arXiv record public.
...
in the private `variantum-admin` repository. Do not upload this bundle publicly
until all four authors have approved it.
